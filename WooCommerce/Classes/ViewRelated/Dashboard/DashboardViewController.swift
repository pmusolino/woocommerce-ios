...
class DashboardViewController: UIViewController {
    ...
    @IBOutlet private weak var insightsHeightConstraint: NSLayoutConstraint!
    ...
    override func preferredContentSizeDidChange(forChildContentContainer container: UIContentContainer) {
        ...
        if let containerVC = container as? TopPerformersViewController {
            insightsHeightConstraint?.constant = containerVC.preferredContentSize.height
        }
    }
}
